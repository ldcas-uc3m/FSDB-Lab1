...
-- Doctor
insert into Doctor
  select distinct collegiateNum, phoneNum, name, surname1, surname2, passport
  from fsdb.doctors
...
insert into Doctor_Hospital
  select distinct collegiateNum, hospital
  from fsdb.doctors
  where collegiateNum is not null and hospital is not null;
